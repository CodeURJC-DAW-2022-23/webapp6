...
public class DatabaseInitializer {
	...
	public void init() throws IOException, URISyntaxException {
		...
		setBookImage(book1, "/static/img/books-portraits/elantris.jpg");
		bookRepository.save(book1);

		Book book2 = new Book("Nacidos de la bruma", "Brandon Sanderson", "Fantasía");
		setBookImage(book2, "/static/img/books-portraits/nacidos-de-la-bruma.jpg");
		bookRepository.save(book2);

		Book book3 = new Book("El Archivo de las Tormentas", "Brandon Sanderson", "Fantasía");
		setBookImage(book3, "/static/img/books-portraits/el-archivo-de-las-tormentas.jpg");
		bookRepository.save(book3);

		// Sample users
		User admin = new User("admin", passwordEncoder.encode("adminpass"), "admin@gmail.com", "ADMIN");
		userRepository.save(admin);
		User testUser = new User("TestUser", passwordEncoder.encode("pass"), "user@mail.ex", "USER");
		...
		// Sample offers
		Offer testOffer = new Offer(new Date(), "Test Edition", "This is a test description", 10f, book1, testUser);
