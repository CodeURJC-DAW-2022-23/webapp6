...
import { FormWithData } from './components/general-components/form-with-data/form-with-data.component';
...
@NgModule({
  declarations: [
    ...
    BookParticularComponent, OfferComponent, SectionTitle, GeneralTitle, Form, OfferCard, ReviewCard, FormWithData
    //All components
  ],
  imports: [
